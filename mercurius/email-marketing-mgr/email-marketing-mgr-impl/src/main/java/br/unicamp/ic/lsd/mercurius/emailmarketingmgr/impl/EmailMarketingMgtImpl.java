...
class EmailMarketingMgtImpl {

	private EmailMarketingManager manager;

	EmailMarketingMgtImpl(EmailMarketingManager manager) {
		super();
	...
	void sendEmail(List<String> recipientsList, List<Product> products) throws MessagingException {
